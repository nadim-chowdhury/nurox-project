...
import { useGetRecurringJournalsQuery, useCreateRecurringJournalMutation, useGetAccountsQuery } from "@/store/api/financeApi";
    ...
    <div className="animate-fade-in-up">
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleCreate}>
          ...
          <Form.List name="lines" initialValue={[{ accountId: "", debit: 0, credit: 0 }]}>
            {(fields, { add, remove }) => (
              <>
                {fields.map(({ key, name, ...restField }) => (
                  <Space key={key} style={{ display: 'flex', marginBottom: 8 }} align="baseline">
                    ...
                    >
                      <Select placeholder="Account" style={{ width: 300 }} showSearch optionFilterProp="children">
                        {accounts?.map(acc => (
