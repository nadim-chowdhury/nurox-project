      ...
      <Row gutter={[16, 16]}>
        <Col span={24}>
          <Card
            title={
              <Space>
                <BarChartOutlined /> Rating Distribution (Bell Curve)
              </Space>
            }
            style={{
          ...
          >
            ...
            >
              This chart shows the distribution of employee performance ratings.
              Ideally, it should resemble a normal distribution (bell curve).
            </Paragraph>
