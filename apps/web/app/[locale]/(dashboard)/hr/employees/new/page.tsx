...
const STEPS = [
  ...
  },
  {
    title: "Compensation",
    icon: <DollarOutlined />,
    schema: compensationDetailsSchema,
  },
  {
    title: "Emergency",
    icon: <SafetyOutlined />,
...
export default function NewEmployeePage() {
  ...
  const validateStep = async (stepIndex: number, values: any) => {
    ...
    if (processedValues.dateOfBirth)
      processedValues.dateOfBirth = dayjs(
        processedValues.dateOfBirth,
      ).toISOString();
    if (processedValues.joinDate)
      processedValues.joinDate = dayjs(processedValues.joinDate).toISOString();
    if (processedValues.probationEndDate)
      processedValues.probationEndDate = dayjs(
        processedValues.probationEndDate,
      ).toISOString();
    if (processedValues.contractExpiryDate)
      processedValues.contractExpiryDate = dayjs(
        processedValues.contractExpiryDate,
      ).toISOString();
    ...
    try {
      ...
      const formattedData = {
        ...
        dateOfBirth: finalData.dateOfBirth
          ? dayjs(finalData.dateOfBirth).toISOString()
          : undefined,
        joinDate: dayjs(finalData.joinDate).toISOString(),
        probationEndDate: finalData.probationEndDate
          ? dayjs(finalData.probationEndDate).toISOString()
          : undefined,
        contractExpiryDate: finalData.contractExpiryDate
          ? dayjs(finalData.contractExpiryDate).toISOString()
          : undefined,
  ...
  const customRequest = async (options: any) => {
    ...
    try {
      ...
      const resp = await fetch(
        `/api/system/upload-url?fileName=${file.name}&contentType=${file.type}`,
      );
          ...
          <div style={{ display: current === 0 ? "block" : "none" }}>
            ...
            <Row gutter={[24, 0]}>
              ...
              <Col xs={24}>
                <Form.Item
                  name="address"
                  label={<span style={labelStyle}>Current Address</span>}
                >
          ...
          <div style={{ display: current === 1 ? "block" : "none" }}>
            ...
            <Row gutter={[24, 0]}>
              <Col xs={24} sm={12}>
                <Form.Item
                  name="employeeCode"
                  label={<span style={labelStyle}>Employee Code</span>}
                  rules={[{ required: true }]}
                >
              ...
              <Col xs={24} sm={12}>
                <Form.Item
                  ...
                  label={<span style={labelStyle}>Probation End Date</span>}
                >
                  <DatePicker style={{ width: "100%" }} />
                </Form.Item>
              </Col>
          ...
          <div style={{ display: current === 2 ? "block" : "none" }}>
            ...
            <Row gutter={[24, 0]}>
              <Col xs={24} sm={12}>
                <Form.Item
                  name="baseSalary"
                  label={<span style={labelStyle}>Base Salary (Monthly)</span>}
                  rules={[{ required: true }]}
                >
              ...
              <Col xs={24} sm={12}>
                <Form.Item
                  name="routingNumber"
                  label={<span style={labelStyle}>Routing Number</span>}
                >
              ...
              <Col xs={24} sm={12}>
                <Form.Item
                  name="taxId"
                  label={<span style={labelStyle}>Tax ID / TIN</span>}
                >
          ...
          <div style={{ display: current === 4 ? "block" : "none" }}>
            ...
            <Row gutter={[24, 0]}>
              <Col xs={24} sm={12}>
                <Form.Item
                  name="contractUrl"
                  label={<span style={labelStyle}>Contract Upload</span>}
                >
                  <Upload
              ...
              <Col xs={24} sm={12}>
                <Form.Item
                  ...
                  label={<span style={labelStyle}>Contract Expiry Date</span>}
                >
                  <DatePicker style={{ width: "100%" }} />
                </Form.Item>
              </Col>
