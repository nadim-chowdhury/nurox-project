...
export default function MaintenancePage() {
  ...
  const [logMaintenance, { isLoading: isLogging }] =
    useLogMaintenanceMutation();
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "technician",
      render: (text: string) => (
        <Text style={{ color: "var(--color-on-surface-variant)" }}>{text}</Text>
      ),
    },
    {
      title: "Date",
    ...
    <div className="animate-fade-in-up">
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleCreateWorkOrder}>
          ...
          <Form.Item>
            <Button type="primary" htmlType="submit" loading={isLogging} block>
              Create Work Order
            </Button>
          </Form.Item>
        </Form>
