...
const ALL_WIDGETS = [
  ...
  }, // INVENTORY_MANAGER seems logical although not in the list I saw, I'll use ADMIN for now
  {
    id: "new_hires",
    title: "New Hires",
    span: 12,
...
export function DashboardGrid({ dateRange }: DashboardGridProps) {
  ...
  const renderWidget = (id: string) => {
    switch (id) {
      ...
      case "stock_alerts":
        return <StockAlertsWidget dateRange={dateRange} />;
      case "new_hires":
        return <NewHiresWidget dateRange={dateRange} />;
      case "leave_today":
        return <LeaveTodayWidget dateRange={dateRange} />;
      case "open_pos":
        return <OpenPOsWidget dateRange={dateRange} />;
      case "revenue_dept":
        return <RevenueByDeptWidget />;
      case "inventory_aging":
        return <InventoryAgingWidget dateRange={dateRange} />;
      case "top_products":
        return <TopProductsWidget />;
      case "dept_perf":
        return <DepartmentPerformanceWidget />;
      case "overdue_inv":
        return <OverdueInvoicesWidget />;
      case "attendance_rate":
        return <AttendanceRateWidget />;
      case "birthdays":
        return <UpcomingBirthdaysWidget />;
      case "sales_pipeline":
        return <SalesPipelineWidget />;
      case "procurement_lead":
        return <ProcurementLeadTimeWidget />;
      case "exec_summary":
