    ...
    <Modal
      title={
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span>
            Promotion Wizard: {employee?.firstName} {employee?.lastName}
          </span>
        </div>
      }
      open={open}
        ...
        {currentStep === 0 && (
          <Row gutter={24}>
            ...
            <Col span={12}>
              ...
              <Form.Item
                name="proposedGradeId"
                label="Proposed Grade (Optional)"
              >
            ...
            <Col span={12}>
              ...
              <Form.Item label="Percentage Increase">
                <InputNumber
                  ...
                  style={{ width: "100%" }}
                  value={
                    form.getFieldValue("proposedSalary")
                      ? Math.round(
                          ((form.getFieldValue("proposedSalary") -
                            (employee?.salary || 0)) /
                            (employee?.salary || 1)) *
        ...
        {currentStep === 2 && (
          <>
            ...
            <Form.Item name="comments" label="Justification / Comments">
              <TextArea
                rows={4}
                placeholder="Briefly describe the reason for this promotion..."
              />
            </Form.Item>
          </>
        )}
