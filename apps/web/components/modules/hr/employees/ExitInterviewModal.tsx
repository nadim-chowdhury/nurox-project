...
import { Modal, Form, Rate, Radio, Input, message, Divider } from "antd";
import { FileSearchOutlined } from "@ant-design/icons";
import { useSubmitExitInterviewMutation } from "@/store/api/hrApi";
  ...
  return (
    <Modal
      title={
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span>
            Exit Interview: {employee?.firstName} {employee?.lastName}
          </span>
        </div>
      }
      open={open}
    ...
    >
      <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
        ...
        <Form.Item
          name="satisfactionWithRole"
          label="Satisfaction with your role & responsibilities?"
          rules={[{ required: true }]}
        >
          <Rate />
        </Form.Item>
        ...
        <Form.Item
          name="satisfactionWithManagement"
          label="Satisfaction with company management?"
          rules={[{ required: true }]}
        >
          <Rate />
        </Form.Item>
        ...
        <Form.Item
          ...
          label="Would you recommend Nurox as a place to work?"
          rules={[{ required: true }]}
        >
          <Radio.Group>
