...
import { useGetSuccessionPlansQuery } from "@/store/api/hrApi";
...
export function SuccessionTab({ employeeId }: Props) {
  ...
  const getReadinessColor = (readiness: string) => {
    switch (readiness) {
      case "READY_NOW":
        return "green";
      case "READY_IN_1_YEAR":
        return "blue";
      case "READY_IN_2_YEARS":
        return "orange";
      default:
        return "default";
    }
  ...
  return (
    <div>
      <Title level={5} style={{ marginBottom: 16 }}>
        Career Progression & Succession Path
      </Title>
          ...
          >
            ...
            >
              <Space direction="vertical" size={4}>
                ...
                <Tag color={getReadinessColor(item.readiness)}>
              ...
              <div style={{ width: 150, textAlign: "right" }}>
                ...
                <Progress
                  percent={getReadinessPercent(item.readiness)}
                  size="small"
            ...
            {item.developmentPlan && (
              ...
              >
                <Text strong style={{ fontSize: 12 }}>
                  <StarOutlined /> Development Focus:
                </Text>
                <Paragraph
