...
export function PerformanceTab({ employeeId }: Props) {
  const { data: reviews, isLoading } = useGetPerformanceReviewsQuery({
    employeeId,
    type: "THREE_SIXTY",
  });
  const [selectedReview, setSelectedReview] = useState<any>(null);
  const { data: summary, isLoading: isSummaryLoading } =
    useGetReviewSummaryQuery(selectedReview?.id, {
      skip: !selectedReview,
    });
            ...
            >
              ...
              {isSummaryLoading ? (
                ...
                <>
                  ...
                  <Title level={5}>
                    <MessageOutlined /> Feedback Comments
                  </Title>
                  <List
