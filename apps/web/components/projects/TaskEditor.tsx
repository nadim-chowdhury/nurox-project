...
export default function TaskEditor({
  ...
  const editor = useEditor({
    ...
    content:
      initialData?.description || "<p>Enter task description here...</p>",
  });
    ...
    >
      ...
      >
        ...
        <Button
          ...
          icon={
            isTimerRunning ? <PauseCircleOutlined /> : <PlayCircleOutlined />
          }
          onClick={toggleTimer}
        >
      ...
      <Form form={form} layout="vertical" initialValues={initialData}>
        <Form.Item
          name="title"
          label={
            <span style={{ color: "var(--color-on-surface)" }}>Task Title</span>
          }
          rules={[{ required: true }]}
        >
          <Input
        ...
        <Space style={{ display: "flex", width: "100%", gap: "16px" }}>
          <Form.Item
            name="priority"
            label={
              <span style={{ color: "var(--color-on-surface)" }}>Priority</span>
            }
            initialValue="MEDIUM"
            style={{ flex: 1 }}
          >
            <Select dropdownStyle={{ background: "var(--color-surface-high)" }}>
          ...
          <Form.Item
            name="status"
            label={
              <span style={{ color: "var(--color-on-surface)" }}>Status</span>
            }
