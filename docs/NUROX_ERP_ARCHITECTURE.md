...
├── .github/
│   └── workflows/
│       ├── pr.yml                        # Lint, typecheck, unit tests on PR
│       └── deploy.yml                    # Build, push GHCR, rolling K8s deploy on main
│
├── apps/
│   │
...
│   │   │   │
│   │   │   ├── (dashboard)/              # Protected routes (wrapped by middleware.ts)
...
│   │   │   │   │   │   ├── new/
│   │   │   │   │   │   │   └── page.tsx  # Multi-step new hire wizard
│   │   │   │   │   │   └── [id]/
...
│   │   │   │   │   ├── runs/
│   │   │   │   │   │   ├── page.tsx      # Payroll run list
│   │   │   │   │   │   └── [id]/
│   │   │   │   │   │       └── page.tsx  # Run detail + approval
│   │   │   │   │   ├── salary-structures/
│   │   │   │   │   │   └── page.tsx
│   │   │   │   │   └── payslips/
│   │   │   │   │       └── page.tsx
...
│   │   │   │   │
│   │   │   │   ├── leave/
│   │   │   │   │   ├── page.tsx          # Leave overview + team calendar
│   │   │   │   │   ├── apply/
│   │   │   │   │   │   └── page.tsx
│   │   │   │   │   ├── approvals/
│   │   │   │   │   │   └── page.tsx
...
│   │   │   │   ├── Sidebar.tsx           # antd Layout.Sider + Menu
│   │   │   │   ├── TopBar.tsx            # antd Layout.Header — glassmorphism
│   │   │   │   ├── Breadcrumbs.tsx       # Auto-generated from route segments
│   │   │   │   ├── CommandPalette.tsx    # ⌘K global search (cmdk)
│   │   │   │   └── NotificationPanel.tsx # antd Popover + Tabs for notifications
│   │   │   │
│   │   │   ├── ui/
│   │   │   │   ├── KpiCard.tsx           # Statistic with Space Grotesk number
│   │   │   │   ├── StatusTag.tsx         # antd Tag with semantic color mapping
│   │   │   │   ├── Avatar.tsx            # antd Avatar with initials fallback
│   │   │   │   ├── PageHeader.tsx        # Title + breadcrumb + action buttons
│   │   │   │   ├── ConfirmModal.tsx      # antd Modal.confirm wrapper
│   │   │   │   ├── EmptyState.tsx        # antd Empty with custom illustration
│   │   │   │   └── SkeletonTable.tsx     # antd Skeleton for table loading
│   │   │   │
│   │   │   ├── forms/
│   │   │   │   ├── RhfInput.tsx          # RHF Controller + antd Input
│   │   │   │   ├── RhfSelect.tsx         # RHF Controller + antd Select
│   │   │   │   ├── RhfDatePicker.tsx     # RHF Controller + antd DatePicker
│   │   │   │   ├── RhfUpload.tsx         # RHF Controller + antd Upload
│   │   │   │   ├── RhfEditor.tsx         # RHF Controller + Tiptap
│   │   │   │   └── MultiStepForm.tsx     # antd Steps + form pages
│   │   │   │
│   │   │   ├── tables/
│   │   │   │   ├── DataTable.tsx         # antd Table wrapper (standard use)
│   │   │   │   ├── VirtualTable.tsx      # TanStack Table + TanStack Virtual (10k+ rows only)
│   │   │   │   └── TableToolbar.tsx      # Search + filter + export actions
│   │   │   │
│   │   │   ├── charts/
│   │   │   │   ├── BarChart.tsx          # Recharts Bar with Deep Space theme
│   │   │   │   ├── LineChart.tsx         # Recharts Line
│   │   │   │   ├── AreaChart.tsx         # Recharts Area
│   │   │   │   ├── PieChart.tsx          # Recharts Pie/Donut
│   │   │   │   └── ChartTooltip.tsx      # Custom tooltip matching design system
│   │   │   │
...
│   │   │   │
│   │   │   └── shared/
│   │   │       └── LogoMark.tsx          # Nurox isometric cube SVG + wordmark
│   │   │
│   │   ├── store/
│   │   │   ├── index.ts                  # Redux store setup with redux-persist
│   │   │   ├── slices/
│   │   │   │   ├── authSlice.ts          # User, accessToken, permissions
│   │   │   │   ├── uiSlice.ts            # Sidebar collapse, theme, locale
│   │   │   │   └── notificationSlice.ts  # Unread count, notification list
│   │   │   └── api/                      # RTK Query services
│   │   │       ├── baseApi.ts            # createApi with fetchBaseQuery
│   │   │       ├── authApi.ts
│   │   │       ├── employeeApi.ts
│   │   │       ├── payrollApi.ts
│   │   │       ├── attendanceApi.ts
...
│   │   │
│   │   ├── hooks/
│   │   │   ├── usePermission.ts          # Check permission from session
│   │   │   ├── useSocket.ts              # Socket.io connection hook
│   │   │   ├── useDebounce.ts
│   │   │   ├── usePagination.ts
│   │   │   └── useBreakpoint.ts          # antd useBreakpoint wrapper
│   │   │
│   │   ├── i18n/
...
│       ├── src/
│       │   ├── main.ts                   # Bootstrap: Swagger, CORS, pipes, Pino
│       │   ├── app.module.ts             # Root module
│       │   │
│       │   ├── config/
│       │   │   ├── app.config.ts         # @nestjs/config schema
│       │   │   ├── typeorm.config.ts     # TypeORM DataSource
│       │   │   ├── redis.config.ts
│       │   │   └── bullmq.config.ts
│       │   │
│       │   ├── common/
...
│       │   │   │   └── transform.interceptor.ts    # Wrap all responses: { data, meta }
│       │   │   ├── filters/
...
│       │   │   │   └── parse-uuid.pipe.ts
│       │   │   ├── middleware/
│       │   │   │   ├── tenant.middleware.ts        # Resolve tenantId from header
...
│       │   │   │   ├── candidate.entity.ts
│       │   │   │   ├── interview.entity.ts
│       │   │   │   ├── account.entity.ts            # Chart of accounts
...
│       │   │   ├── migrations/                      # TypeORM auto-generated
│       │   │   │   └── .gitkeep
│       │   │   └── seeds/
│       │   │       ├── run-seeds.ts
│       │   │       ├── tenant.seed.ts
...
│       │       │   ├── payroll.service.ts
│       │       │   ├── payroll-compute.service.ts   # Gross/net calculation logic
│       │       │   ├── payroll.processor.ts          # BullMQ worker
│       │       │   └── dto/
│       │       │
│       │       ├── attendance/
...
│       │       │   ├── biometric-sync.service.ts    # ZKTeco TCP bridge
│       │       │   └── dto/
│       │       │
│       │       ├── leave/
│       │       │   ├── leave.module.ts
...
│       │       │   ├── email.processor.ts            # BullMQ email worker
│       │       │   └── sms.processor.ts              # BullMQ SMS worker
│       │       │
│       │       ├── reports/
│       │       │   ├── reports.module.ts
│       │       │   ├── reports.controller.ts
│       │       │   ├── reports.service.ts
│       │       │   ├── pdf.service.ts               # Puppeteer wrapper
│       │       │   └── excel.service.ts             # ExcelJS wrapper
│       │       │
│       │       └── settings/
│       │           ├── settings.module.ts
...
│   │   └── tsconfig.json
│   │
│   ├── zod-schemas/                      # Shared Zod schemas (frontend + backend)
│   │   ├── src/
│   │   │   ├── index.ts
│   │   │   ├── auth/
│   │   │   │   └── auth.schema.ts
...
│   │   └── tsconfig.json
│   │
│   └── ui-tokens/                        # Design tokens wired to antd ConfigProvider
│       ├── src/
│       │   ├── index.ts
...
│       │   ├── spacing.ts
│       │   ├── elevation.ts
│       │   └── antd-theme.ts             # Exports nuroxTheme ThemeConfig object
│       ├── package.json
│       └── tsconfig.json
│
├── infra/
...
├── .storybook/
│   ├── main.ts
│   └── preview.ts                        # AntdProvider decorator for stories
│
├── turbo.json                            # Turborepo pipeline config
├── package.json                          # Root workspace package.json
├── pnpm-workspace.yaml
├── tsconfig.base.json
├── .eslintrc.js                          # Flat ESLint 9 config
├── .prettierrc
├── .env.example
└── README.md
```
